package com.sun.demo.redis.service;
...
public class RedisService{
     ...
     * @return
     */
    public Object hmDelect(String key, Object hashKey){
        HashOperations<String, Object, Object>  hash = redisTemplate.opsForHash();
     ...
     * @param scoure
     */
    public void addOrderedSet(String key,Object value,double scoure){
     ...
     * @return
     */
    public Set<Object> getOrderedSet(String key,double start,double end){
        ZSetOperations<String, Object> zset = redisTemplate.opsForZSet();
